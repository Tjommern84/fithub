-- ============================================
-- Hotfix: fjern duplikat search_services()-overload
--
-- 21_add_utendors_category.sql ble feilaktig bygget fra den utdaterte
-- 15-param-versjonen i 01_postgis_and_search.sql i stedet for den faktisk
-- kjørende 16-param-versjonen (p_offset + cover_image_url/logo_image_url
-- fra migrasjon 13/14), og manglet DROP FUNCTION-linjene som fjerner gamle
-- signaturer. Resultat: to overlappende overloads → PostgREST kan ikke
-- velge kandidat. Denne filen fjerner begge gamle signaturer og gjenoppretter
-- KUN den korrekte 16-param-versjonen, med utendors-grenen inkludert.
-- ============================================
...
DROP FUNCTION IF EXISTS search_services(text,double precision,double precision,text,text,text,text,text,text,integer,text,text,text,text[],double precision,integer);
DROP FUNCTION IF EXISTS search_services(text,double precision,double precision,text,text,text,text,text,text,integer,text,text,text,text[],double precision,int);
