-- ============================================
-- Legg til 'utendors' main_category i search_services()
-- Run AFTER 01_postgis_and_search.sql (og alle senere migrasjoner)
--
-- Additiv endring: ingen rader i services endres.
-- Full funksjonskropp kopiert fra sql/01_postgis_and_search.sql,
-- med én ny CASE-gren i p_main_category-matchingen.
-- ============================================
